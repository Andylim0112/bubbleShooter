...
def visit(row_idx, col_idx, color=None):
    ...
    if color and map[row_idx][col_idx] != color:
        return
    #skip if bubbles is empty space or not existable
...
curr_fire_count = FIRE_COUNT
wall_height = 0 #height of the wall on the screen
to_angle = 0 #angle
angle_speed = 1.5 #move 1.5degrees

is_game_over = False
game_font = pygame.font.SysFont("arialrounded", 35)
game_result = None 

map = []
visited =[] #stores visited position
